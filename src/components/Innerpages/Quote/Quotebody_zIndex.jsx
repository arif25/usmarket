...
$(document).ready(function(){
    // console.log("z index Page:-----")
    $(".searchboxSelectDropdown").click(function(){
        $("#container_loading").hide();
        $("#quoteSearch_zindex").hide();
    })
 ...
 $("#btnSupportResistance").click(function(){
     ...
     setInterval(function(){
         if (! $('#quoteSearch_zindex').children().length > 0 ) {
        }
     }, 1000)
     $("#showSupportResistance").click(function(){
         $("#showSupportResistance").hide();
  ...
  window.x_getItem = localStorage.getItem("searchlist_portfolio");
        ...
        React.useEffect(() => {
            if(!window.x_getItem){
                ...
                fetch("https://webapp20211006.zsenia.com/data/zportfolio/zindex", requestOptions)
...
if(!window.x_getItem){
    ...
    localStorage.setItem("cookies_zindex", searchTerm_1); 
    window.x_getItem = localStorage.getItem("cookies_zindex");
}
else {
    window.x_getItem = localStorage.getItem("cookies_zindex");
} 
            ...
            <div className="quoteSearchDropbox">
                ...
                <div className="searchboxQuote">
                    <InputGroup className="mb-3">
                        <input type="text" placeholder="Search Index" id="listInputZindex" autocomplete="off"/>
                        <Button variant="outline-secondary" id="button-addon2">{ iconfaSearch }</Button>
                    </InputGroup>                      
                    <div class="loading-box" id="container_loading_zindex">
                        <div class="loader"></div>
                        <h6>Loading...</h6>
                    </div>
                    <div className="quoteSearch" id="quoteSearch_zindex">
...
$(document).ready(function(){
    ...
    $('.listSelectZindex').click(function() { 
        console.log('ZINDEX ----');
    });
    $('#listInputZindex').keyup(function() {
        // $("#quoteSearch_zindex").show();
        $("#container_loading_zindex").show(200);
        inputSearchTerm = $("#listInputZindex").val();
        setTimeout(function(){
        ...
        setTimeout(function(){
            if(window.x_getItem.length > 0){
                $("#container_loading_zindex").hide(200);
                $("#quoteSearch_zindex").show();
                var searchTerm_portfolio = window.x_getItem;
                global.searchData_portfolio.map((searchTerm, indexPort)=>{
                    console.log(" === searchTerm_portfolio map: --- " +  searchTerm.name)
                    document.getElementById("quoteSearch_zindex").innerHTML += "<div class='listSelect listSelectZindex' onClick = {this.shoot}>" + searchTerm.name + "<div />";
                })
            }
        }, 2000);
      });
